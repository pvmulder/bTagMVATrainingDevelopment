...
#  ./fitter CombinedSV${i}Vertex_B_histo.root
#  mv out.txt weights/CombinedSV${i}Vertex_B_histo.txt
#  mv out.root weights/CombinedSV${i}Vertex_B_histo_check.root
#
#  ./fitter CombinedSV${i}Vertex_C_histo.root
#  mv out.txt weights/CombinedSV${i}Vertex_C_histo.txt
#  mv out.root weights/CombinedSV${i}Vertex_C_histo_check.root
#
#  ./fitter CombinedSV${i}Vertex_DUSG_histo.root
#  mv out.txt weights/CombinedSV${i}Vertex_DUSG_histo.txt
#  mv out.root weights/CombinedSV${i}Vertex_DUSG_histo_check.root
done
