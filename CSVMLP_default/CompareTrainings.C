...
void CompareTrainings()
{
  ...
  gStyle->SetOptStat(0);
	...
	//TString fileName2 = "../Reweighting_default/DQM_V0001_R000000001__POG__BTAG__categories.root";
	TString fileName2 = "../CSVMVA/DQM_V0001_R000000001__POG__BTAG__oldtraining.root";
  ...
  CSV2_FlavEffVsBEff_DUSG->Draw("same");  
	...
	leg = new TLegend(0.2,0.6,0.6,0.7);
  leg->SetFillColor(0);
  leg->AddEntry(CSV1_FlavEffVsBEff_DUSG,"CSV NN new","p");
  leg->AddEntry(CSV2_FlavEffVsBEff_DUSG,"CSV NN old","p");
  
  leg->Draw();
	plotname = dir+"/FlavEffVsBEff_DUSG_newbias.png";
  ...
  CSV2_FlavEffVsBEff_C->Draw("same");  
	...
	leg = new TLegend(0.2,0.6,0.6,0.7);
  leg->SetFillColor(0);
  leg->AddEntry(CSV1_FlavEffVsBEff_C,"CSV NN new","p");
  leg->AddEntry(CSV2_FlavEffVsBEff_C,"CSV NN old","p");
  
  leg->Draw();
	plotname = dir+"/FlavEffVsBEff_C_newbias.png";
