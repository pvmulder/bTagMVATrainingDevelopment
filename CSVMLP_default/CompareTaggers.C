...
void CompareTaggers()
{
  ...
  gStyle->SetOptStat(0);
	...
	string dir = "Plots_CompareLRandNN_";
...
*/
	...
	TH1F * TCHE_FlavEffVsBEff_DUSG = (TH1F*) file2->Get("DQMData/Run 1/Btag/Run summary/TCHE_GLOBAL/FlavEffVsBEff_DUSG_discr_TCHE_GLOBAL");
	TH1F * TCHP_FlavEffVsBEff_DUSG = (TH1F*) file2->Get("DQMData/Run 1/Btag/Run summary/TCHP_GLOBAL/FlavEffVsBEff_DUSG_discr_TCHP_GLOBAL");
	TH1F * CSV_FlavEffVsBEff_DUSG = (TH1F*) file2->Get("DQMData/Run 1/Btag/Run summary/CSV_GLOBAL/FlavEffVsBEff_DUSG_discr_CSV_GLOBAL");
	TH1F * SSVHE_FlavEffVsBEff_DUSG = (TH1F*) file2->Get("DQMData/Run 1/Btag/Run summary/SSVHE_GLOBAL/FlavEffVsBEff_DUSG_discr_SSVHE_GLOBAL");
	TH1F * SSVHP_FlavEffVsBEff_DUSG = (TH1F*) file2->Get("DQMData/Run 1/Btag/Run summary/SSVHP_GLOBAL/FlavEffVsBEff_DUSG_discr_SSVHP_GLOBAL");

	TH1F * CSVMVA_FlavEffVsBEff_DUSG = (TH1F*) file1->Get("DQMData/Run 1/Btag/Run summary/CSV_GLOBAL/FlavEffVsBEff_DUSG_discr_CSV_GLOBAL");
  ...
  CSVMVA_FlavEffVsBEff_DUSG->SetMarkerColor(6);
  CSVMVA_FlavEffVsBEff_DUSG->Draw("same");  
  CSV_FlavEffVsBEff_DUSG->SetMarkerColor(4);
  CSV_FlavEffVsBEff_DUSG->Draw("same");  
  ...
  leg->AddEntry(CSV_FlavEffVsBEff_DUSG,"CSV LR","p");
  leg->AddEntry(CSVMVA_FlavEffVsBEff_DUSG,"CSV NN","p");
  ...
  leg->Draw();
	...
	TH1F * TCHE_FlavEffVsBEff_C = (TH1F*) file2->Get("DQMData/Run 1/Btag/Run summary/TCHE_GLOBAL/FlavEffVsBEff_C_discr_TCHE_GLOBAL");
	TH1F * TCHP_FlavEffVsBEff_C = (TH1F*) file2->Get("DQMData/Run 1/Btag/Run summary/TCHP_GLOBAL/FlavEffVsBEff_C_discr_TCHP_GLOBAL");
	TH1F * CSV_FlavEffVsBEff_C = (TH1F*) file2->Get("DQMData/Run 1/Btag/Run summary/CSV_GLOBAL/FlavEffVsBEff_C_discr_CSV_GLOBAL");
	TH1F * SSVHE_FlavEffVsBEff_C = (TH1F*) file2->Get("DQMData/Run 1/Btag/Run summary/SSVHE_GLOBAL/FlavEffVsBEff_C_discr_SSVHE_GLOBAL");
	TH1F * SSVHP_FlavEffVsBEff_C = (TH1F*) file2->Get("DQMData/Run 1/Btag/Run summary/SSVHP_GLOBAL/FlavEffVsBEff_C_discr_SSVHP_GLOBAL");

	TH1F * CSVMVA_FlavEffVsBEff_C = (TH1F*) file1->Get("DQMData/Run 1/Btag/Run summary/CSV_GLOBAL/FlavEffVsBEff_C_discr_CSV_GLOBAL");
  ...
  CSVMVA_FlavEffVsBEff_C->SetMarkerColor(6);
  CSVMVA_FlavEffVsBEff_C->Draw("same");  
  CSV_FlavEffVsBEff_C->SetMarkerColor(4);
  CSV_FlavEffVsBEff_C->Draw("same");  
  ...
  leg->AddEntry(CSV_FlavEffVsBEff_C,"CSV LR","p");
  leg->AddEntry(CSVMVA_FlavEffVsBEff_C,"CSV NN","p");
  leg->Draw();
