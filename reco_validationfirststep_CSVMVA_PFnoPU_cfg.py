...
process.BTauMVAJetTagComputerRecord = cms.ESSource("PoolDBESSource",
	...
	connect = cms.string("sqlite_file:MVAJetTags_withPFnoPU_Adding2HighPtBins_nonFit-Reweighting.db"), ######## REPLACE!!!
...
#this should not work, but it was not commented in INTERACTIVE_validationwithPFnoPU_Fix_Adding2HighPtTrainBin_NEW_50k
#from RecoBTag.SecondaryVertex.combinedSecondaryVertexCommon_cfi import*
#process.combinedSecondaryVertexCommon.trackMultiplicityMin = cms.uint32(1)
...
process.btagDQM = cms.Path(process.goodOfflinePrimaryVertices * process.JECAlgo * process.flavourSeq * process.myak5JetTracksAssociatorAtVertex * process.btagging * process.CustombTagValidation)
