...
for i in $CAT ; do
	...
	rfcp /castor/cern.ch/user/d/descroix/MVA-Samples/MC_QCD_Tune4C_7TeV_pythia8_CombinedSV${i}Vertex_C.root /tmp/${USER}/CombinedSV${i}Vertex_C_histo.root
	rfcp /castor/cern.ch/user/d/descroix/MVA-Samples/MC_QCD_Tune4C_7TeV_pythia8_CombinedSV${i}Vertex_B_DUSG.root /tmp/${USER}/CombinedSV${i}Vertex_B_DUSG_histo.root
        rfcp /castor/cern.ch/user/d/descroix/MVA-Samples/MC_QCD_Tune4C_7TeV_pythia8_CombinedSV${i}Vertex_DUSG.root /tmp/${USER}/CombinedSV${i}Vertex_DUSG_histo.root
        ln -s /tmp/${USER}/CombinedSV${i}Vertex_B_C_histo.root CombinedSV${i}Vertex_B_C.root
...
mkdir weights
for i in $CAT ; do
        #rfcp /castor/cern.ch/user/d/descroix/MVA-Samples/MC_QCD_Tune4C_7TeV_pythia8_CombinedSV${i}Vertex_B_C.root CombinedSV${i}Vertex_B_C_histo.root
  ...
  mv out.root weights/CombinedSV${i}Vertex_BC_histo_check.root
        #rm CombinedSV${i}Vertex_B_C_histo.root

	#rfcp /castor/cern.ch/user/d/descroix/MVA-Samples/MC_QCD_Tune4C_7TeV_pythia8_CombinedSV${i}Vertex_B.root CombinedSV${i}Vertex_B_histo.root
	#rfcp /castor/cern.ch/user/d/descroix/MVA-Samples/MC_QCD_Tune4C_7TeV_pythia8_CombinedSV${i}Vertex_C.root CombinedSV${i}Vertex_C_histo.root
  ...
  mv out.root weights/CombinedSV${i}Vertex_B_C_ratio_check.root
        #rm CombinedSV${i}Vertex_B_histo.root
        #rm CombinedSV${i}Vertex_C_histo.root

	#rfcp /castor/cern.ch/user/d/descroix/MVA-Samples/MC_QCD_Tune4C_7TeV_pythia8_CombinedSV${i}Vertex_B_DUSG.root CombinedSV${i}Vertex_B_DUSG_histo.root
  ...
  mv out.root weights/CombinedSV${i}Vertex_BL_ratio_check.root
	#rm CombinedSV${i}Vertex_B_DUSG_histo.root

	#rfcp /castor/cern.ch/user/d/descroix/MVA-Samples/MC_QCD_Tune4C_7TeV_pythia8_CombinedSV${i}Vertex_B.root CombinedSV${i}Vertex_B_histo.root
	#rfcp /castor/cern.ch/user/d/descroix/MVA-Samples/MC_QCD_Tune4C_7TeV_pythia8_CombinedSV${i}Vertex_DUSG.root CombinedSV${i}Vertex_DUSG_histo.root
  ...
  mv out.root weights/CombinedSV${i}Vertex_B_DUSG_ratio_check.root
	#rm CombinedSV${i}Vertex_B_histo.root
	#rm CombinedSV${i}Vertex_DUSG_histo.root
done
